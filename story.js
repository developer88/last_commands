...
squiffy.story.sections = {
	...
	'Yes': {
		'clear': true,
		'text': "<p><strong>Status</strong>: ✅ Security system is diactivated. The entrance door is unlocked.</p>\n<p>Have a nice day and <strong>Happy Birthday</strong> 🎂</p>\n<p>{current time}</p>",
		'passages': {
		},
	},
}
